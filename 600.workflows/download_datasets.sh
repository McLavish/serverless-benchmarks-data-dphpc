...
tar -xzf "$ARCHIVE" \
  --directory . \
  6100.1000-genome/ALL.chr21.phase3_shapeit2_mvncall_integrated_v5.20130502.sites.annotation.vcf \
  6101.1000-genome-individuals/ALL.chr21.phase3_shapeit2_mvncall_integrated_v5.20130502.sites.annotation.vcf \
  631.parallel-download/data-1048576-bytes.txt \
  650.vid/frozen_inference_graph.pb \
  660.map-reduce/words
